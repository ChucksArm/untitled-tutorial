export default function Module4() {
  return (
    <div style={{ padding: '2rem' }}>
      <h1>☁️ Module 4: AWS Infrastructure</h1>
      <p>Master cloud deployment and scaling with Amazon Web Services</p>
      ...
      <ol>
        <li><strong>Compute Services</strong>
          <ul>
            <li>EC2 instance types and sizing</li>
      ...
      <h2>Project: Deploy Music App</h2>
      <ul>
        <li>Launch EC2 instances</li>
        <li>Configure RDS PostgreSQL</li>
        <li>Setup S3 for media storage</li>
        <li>Configure CloudFront CDN</li>
        <li>Setup monitoring with CloudWatch</li>
      </ul>
      <h2>Resources</h2>
      <ul>
